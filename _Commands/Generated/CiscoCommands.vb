Namespace Commands
	...
	''' <generator-date>08/02/2014 18:07:51</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Caerus\_Commands\Generated\CiscoCommands.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Caerus\_Commands\Generated\CiscoCommands.tt", "1")> _
	<Leviathan.Commands.Command(ResourceContainingType:=GetType(CiscoCommands), ResourceName:="CommandDetails", Name:="cisco", Description:="@commandCiscoDescription@", Hidden:=False)> _
