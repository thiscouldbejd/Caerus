Namespace QNAP
	...
	''' <summary>Class Representing a Hard Drive in a QNAP Storage System</summary>
	''' <autogenerated>Generated from a T4 template. Modifications will be lost, if applicable use a partial class instead.</autogenerated>
	''' <generator-date>08/02/2014 18:24:45</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Caerus\_QNAP\Generated\HardDrive.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Caerus\_QNAP\Generated\HardDrive.tt", "1")> _
	...
	Partial Public Class HardDrive
		...
		#Region " Public Constructors "
			...
			Public Sub New( _
				ByVal _Index As System.Int32, _
				ByVal _Description As System.String, _
				ByVal _Temperature As Temperature _
			)
			...
			Public Sub New( _
				...
				ByVal _Status As HDStatus, _
				ByVal _Model As System.String, _
				ByVal _Capacity As System.String _
			)
			...
			Public Sub New( _
				...
				ByVal _Model As System.String, _
				ByVal _Capacity As System.String, _
				ByVal _SMART As System.String _
			)
			...
			#Region " IComparable Implementation "
				...
				#Region " Public Methods "
					...
					Public Overridable Function IComparable_CompareTo( _
						...
						Dim typed_Value As HardDrive = TryCast(value, HardDrive)
			...
			#Region " IFormattable Implementation "
				...
				#Region " Public Shared Methods "
					...
					Public Shared Function ToString_default( _
						...
						ByVal Capacity As System.String _
					) As String
		...
		#Region " Public Constants "
			...
			''' <summary>Public Shared Reference to the Name of the Property: Temperature</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_TEMPERATURE As String = "Temperature"
			...
			''' <summary>Public Shared Reference to the Name of the Property: Capacity</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_CAPACITY As String = "Capacity"

			''' <summary>Public Shared Reference to the Name of the Property: SMART</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_SMART As String = "SMART"
		...
		#Region " Private Variables "
			...
			''' <summary>Private Data Storage Variable for Property: Temperature</summary>
			''' <remarks></remarks>
			Private m_Temperature As Temperature

			''' <summary>Private Data Storage Variable for Property: Status</summary>
			''' <remarks></remarks>
			Private m_Status As HDStatus

			''' <summary>Private Data Storage Variable for Property: Model</summary>
			''' <remarks></remarks>
			Private m_Model As System.String

			''' <summary>Private Data Storage Variable for Property: Capacity</summary>
			''' <remarks></remarks>
			Private m_Capacity As System.String

			''' <summary>Private Data Storage Variable for Property: SMART</summary>
			''' <remarks></remarks>
			Private m_SMART As System.String
		...
		#Region " Public Properties "
			...
			''' <summary>Provides Access to the Property: Temperature</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="Temperature")> _
			...
			Public Property Status() As HDStatus
				Get
					Return m_Status
				End Get
				Set(value As HDStatus)
					m_Status = value
				End Set
			End Property
			...
			''' <summary>Provides Access to the Property: Capacity</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="Capacity")> _
			...
			''' <summary>Provides Access to the Property: SMART</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="SMART")> _
			Public Property SMART() As System.String
				Get
					Return m_SMART
				End Get
				Set(value As System.String)
