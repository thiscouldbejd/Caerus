Namespace QNAP
	...
	''' <summary>Storage Array Device</summary>
	''' <autogenerated>Generated from a T4 template. Modifications will be lost, if applicable use a partial class instead.</autogenerated>
	''' <generator-date>08/02/2014 18:25:19</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Caerus\_QNAP\Generated\StorageArray.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Caerus\_QNAP\Generated\StorageArray.tt", "1")> _
	...
	Partial Public Class StorageArray
		...
		#Region " Public Constructors "
			...
			Public Sub New( _
				...
				ByVal _InterfaceCount As System.Int64, _
				ByVal _Interfaces As Caerus.NetworkInterfaceCollection, _
				ByVal _CPU_Usage As System.String _
			)
			...
			Public Sub New( _
				...
				ByVal _Interfaces As Caerus.NetworkInterfaceCollection, _
				ByVal _CPU_Usage As System.String, _
				ByVal _Total_Memory As System.String _
			)
			...
			Public Sub New( _
				...
				ByVal _CPU_Usage As System.String, _
				ByVal _Total_Memory As System.String, _
				ByVal _Free_Memory As System.String _
			)
			...
			Public Sub New( _
				...
				ByVal _Total_Memory As System.String, _
				ByVal _Free_Memory As System.String, _
				ByVal _CPU_Temperature As Temperature _
			)
			...
			Public Sub New( _
				...
				ByVal _Free_Memory As System.String, _
				ByVal _CPU_Temperature As Temperature, _
				ByVal _System_Temperature As Temperature _
			)
				...
				Free_Memory = _Free_Memory
				CPU_Temperature = _CPU_Temperature
				System_Temperature = _System_Temperature
			...
			Public Sub New( _
				...
				ByVal _CPU_Temperature As Temperature, _
				ByVal _System_Temperature As Temperature, _
				ByVal _Drives As HardDriveCollection _
			)
			...
			Public Sub New( _
				...
				ByVal _System_Temperature As Temperature, _
				ByVal _Drives As HardDriveCollection, _
				ByVal _Volumes As VolumeCollection _
			)
			...
			Public Sub New( _
				...
				ByVal _Drives As HardDriveCollection, _
				ByVal _Volumes As VolumeCollection, _
				ByVal _Fans As FanCollection _
			)
			...
			#Region " IComparable Implementation "
				...
				#Region " Public Methods "
					...
					Public Overridable Function IComparable_CompareTo( _
						...
						Dim typed_Value As StorageArray = TryCast(value, StorageArray)
		...
		#Region " Public Constants "
			...
			''' <summary>Public Shared Reference to the Name of the Property: CPU_Usage</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_CPU_USAGE As String = "CPU_Usage"

			''' <summary>Public Shared Reference to the Name of the Property: Total_Memory</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_TOTAL_MEMORY As String = "Total_Memory"

			''' <summary>Public Shared Reference to the Name of the Property: Free_Memory</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_FREE_MEMORY As String = "Free_Memory"

			''' <summary>Public Shared Reference to the Name of the Property: CPU_Temperature</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_CPU_TEMPERATURE As String = "CPU_Temperature"

			''' <summary>Public Shared Reference to the Name of the Property: System_Temperature</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_SYSTEM_TEMPERATURE As String = "System_Temperature"

			''' <summary>Public Shared Reference to the Name of the Property: Drives</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_DRIVES As String = "Drives"

			''' <summary>Public Shared Reference to the Name of the Property: Volumes</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_VOLUMES As String = "Volumes"
		...
		#Region " Private Variables "
			...
			''' <summary>Private Data Storage Variable for Property: CPU_Usage</summary>
			''' <remarks></remarks>
			Private m_CPU_Usage As System.String

			''' <summary>Private Data Storage Variable for Property: Total_Memory</summary>
			''' <remarks></remarks>
			Private m_Total_Memory As System.String

			''' <summary>Private Data Storage Variable for Property: Free_Memory</summary>
			''' <remarks></remarks>
			Private m_Free_Memory As System.String

			''' <summary>Private Data Storage Variable for Property: CPU_Temperature</summary>
			''' <remarks></remarks>
			Private m_CPU_Temperature As Temperature

			''' <summary>Private Data Storage Variable for Property: System_Temperature</summary>
			''' <remarks></remarks>
			Private m_System_Temperature As Temperature

			''' <summary>Private Data Storage Variable for Property: Drives</summary>
			''' <remarks></remarks>
			Private m_Drives As HardDriveCollection

			''' <summary>Private Data Storage Variable for Property: Volumes</summary>
			''' <remarks></remarks>
			Private m_Volumes As VolumeCollection

			''' <summary>Private Data Storage Variable for Property: Fans</summary>
			''' <remarks></remarks>
			Private m_Fans As FanCollection
		...
		#Region " Public Properties "
			...
			''' <summary>Provides Access to the Property: CPU_Usage</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="CPU_Usage")> _
			Public Property CPU_Usage() As System.String
				Get
					Return m_CPU_Usage
				End Get
				Set(value As System.String)
			...
			''' <summary>Provides Access to the Property: Total_Memory</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="Total_Memory")> _
			Public Property Total_Memory() As System.String
				Get
			...
			''' <summary>Provides Access to the Property: Free_Memory</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="Free_Memory")> _
			Public Property Free_Memory() As System.String
				Get
			...
			''' <summary>Provides Access to the Property: CPU_Temperature</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="CPU_Temperature")> _
			Public Property CPU_Temperature() As Temperature
				Get
					Return m_CPU_Temperature
				End Get
				Set(value As Temperature)
					m_CPU_Temperature = value
				End Set
			End Property

			''' <summary>Provides Access to the Property: System_Temperature</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="System_Temperature")> _
			Public Property System_Temperature() As Temperature
				Get
					Return m_System_Temperature
				End Get
				Set(value As Temperature)
					m_System_Temperature = value
				End Set
			End Property

			''' <summary>Provides Access to the Property: Drives</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="Drives")> _
			Public Property Drives() As HardDriveCollection
				Get
					Return m_Drives
				End Get
				Set(value As HardDriveCollection)
					m_Drives = value
				End Set
			End Property

			''' <summary>Provides Access to the Property: Volumes</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="Volumes")> _
			Public Property Volumes() As VolumeCollection
				Get
					Return m_Volumes
				End Get
				Set(value As VolumeCollection)
					m_Volumes = value
				End Set
			End Property
			...
			Public Property Fans() As FanCollection
				Get
					Return m_Fans
				End Get
				Set(value As FanCollection)
					m_Fans = value
				End Set
			End Property
