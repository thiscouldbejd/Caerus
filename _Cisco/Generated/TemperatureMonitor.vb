Namespace Cisco
	...
	''' <summary>Temperature Monitor</summary>
	''' <autogenerated>Generated from a T4 template. Modifications will be lost, if applicable use a partial class instead.</autogenerated>
	''' <generator-date>08/02/2014 18:04:18</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Caerus\_Cisco\Generated\TemperatureMonitor.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Caerus\_Cisco\Generated\TemperatureMonitor.tt", "1")> _
	...
	Partial Public Class TemperatureMonitor
		...
		#Region " Public Constructors "
			...
			Public Sub New( _
				...
				ByVal _Description As System.String, _
				ByVal _Value As System.Int32, _
				ByVal _Threshold As System.Int32 _
			)
			...
			#Region " IComparable Implementation "
				...
				#Region " Public Methods "
					...
					Public Overridable Function IComparable_CompareTo( _
						...
						Dim typed_Value As TemperatureMonitor = TryCast(value, TemperatureMonitor)
		...
		#Region " Public Constants "
			...
			''' <summary>Public Shared Reference to the Name of the Property: Threshold</summary>
			''' <remarks></remarks>
			Public Const PROPERTY_THRESHOLD As String = "Threshold"
		...
		#Region " Private Variables "
			...
			''' <summary>Private Data Storage Variable for Property: Threshold</summary>
			''' <remarks></remarks>
			Private m_Threshold As System.Int32
		...
		#Region " Public Properties "
			...
			''' <summary>Provides Access to the Property: Threshold</summary>
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="Threshold")> _
			Public Property Threshold() As System.Int32
				Get
					Return m_Threshold
				End Get
				Set(value As System.Int32)
