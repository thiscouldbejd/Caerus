Namespace Cisco
	...
	''' <generator-date>08/02/2014 18:04:47</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Caerus\_Cisco\Generated\Vlan.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Caerus\_Cisco\Generated\Vlan.tt", "1")> _
	...
	Partial Public Class Vlan
			...
			#Region " IComparable Implementation "
				...
				#Region " Public Methods "
					...
					Public Overridable Function IComparable_CompareTo( _
						...
						Dim typed_Value As Vlan = TryCast(value, Vlan)
		...
		#Region " Public Properties "
			...
			Public Property State() As VlanState
				Get
					Return m_State
				End Get
				Set(value As VlanState)
					m_State = value
				End Set
			End Property
			...
			Public Property [Type]() As VlanType
				Get
					Return m_Type
				End Get
				Set(value As VlanType)
					m_Type = value
				End Set
			End Property
			...
			''' <remarks></remarks>
			<System.Xml.Serialization.XmlElement(ElementName:="InterfaceIndex")> _
